...
export default function Structured() {
  ...
  return (
    <>
      <Head>
        <title>Structured Finance Strategies | Structured Captital Solutions</title>
        <meta name="description" content="Generated by create next app" />
      </Head>
      <PageContent heading={heading} paragraphs={paragraphs} />
      <ul className="service-info">
        <li>
          Dividend Received Deduction (“DRD”) preference share capital raisings
          with potential Tier 1 and Tier 2 regulatory capital enhancement{" "}
        </li>
