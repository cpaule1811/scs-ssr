      ...
      <div className="nav-wrapper">  
        ...
        <div className="tabs">
            <ul>
                ...
                <li className="right-border"><Link href="/about" passHref><div className={router.pathname === '/about' && "active"}>What We Do</div></Link></li>
                <li className="right-border dropdown-tab"><Link href="/services" passHref><div className={router.pathname.startsWith('/services')}>Services</div></Link>
                ...
                <li className="right-border dropdown-tab"><Link href="/senior-partners" passHref><div className={router.pathname.startsWith('/senior-partners')}>Senior Partners</div></Link>
                  <div className="dropdown-bracket"></div>
                  <div className="dropdown-content">
                ...
                <li>
                      <Link href="/contact" passHref>
                          <div className={router.pathname === '/contact' && 'active'}>Contact Us</div>
                      </Link>
                  </li>
            </ul>
        </div>
