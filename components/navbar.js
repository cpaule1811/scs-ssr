    ...
    <div className="Nav">
      <div className="nav-wrapper">
        <div className="logo-container">
          ...
          <Link href="index" passHref>
            <div className="mini-logo">
              <Image id="mini-logo" href="index" src={logoMini} alt="" />
            </div>
          </Link>
        </div>
        <div className="tabs">
          <ul>
            ...
            <li className="right-border">
              <Link href="/about" passHref>
                <div className={isActive(router.pathname, "/about")}>
                  What We Do
                </div>
              </Link>
            </li>
            <li className="right-border dropdown-tab">
              <Link href="/services" passHref>
                <div className={isActive(router.pathname, "/services")}>
                  Services
                </div>
              </Link>
              <div className="dropdown-bracket" />
              <div className="dropdown-content">
                <Link href="/services/structured-finance-strategies">
                  Structured Finance Strategies
                </Link>
                <Link href="/services/environmental-finance">
                  Environmental Finance
                </Link>
                <Link href="/services/bankrupt-or-distressed-companies">
                  Bankruptcy & Distress Advisory
                </Link>
                <Link href="/services/intellectual-property-financing">
                  Intellectual Property Financing
                </Link>
                <Link href="/services/disclaimer-and-notices">
                  Disclaimer & Notices
                </Link>
              </div>
            </li>
            <li className="right-border dropdown-tab">
              <Link href="/senior-partners" passHref>
                <div className={isActive(router.pathname, "/senior-partners")}>
                  Senior Partners
                </div>
              </Link>
            ...
            <li>
              <Link href="/contact" passHref>
                <div className={isActive(router.pathname, "/contact")}>
                  Contact Us
                </div>
              </Link>
            </li>
        ...
        <div
          ...
          className={`bars-container ${menuStatus && "open"}`}
        >
          <span></span>
          <span></span>
          <span></span>
