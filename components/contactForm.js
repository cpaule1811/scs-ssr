      ...
      <div className="form-container">
        ...
        <form className="form">
          ...
          >
            ...
            <option value="Structured Finance Strategies">
              Structured Finance Strategies
            </option>
            <option value="Bankruptcy & Distress Advisory">
              Bankruptcy & Distress Advisory
            </option>
            <option value="Intellectual Property Financing">
          ...
          <div className="center">
            ...
            <div className="contact-social-wrapper">
              ...
              <Link
                href="https://www.linkedin.com/in/paul-edwards-7b474715/"
                passHref
              >
                <div className="link-button button-style">
