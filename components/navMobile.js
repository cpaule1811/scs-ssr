...
useEffect(() => {
    ...
    return <div className={`mobile-menu ${!menuStatus && " close-ani"}`}>
    <Link href="/" passHref><div className={`mobile-tab ${router.pathname==='/' && 'active'}`}>home</div></Link>
    <Link href="/about" passHref ><div className={`mobile-tab ${isActive(router.pathname, '/about')}`}>What we do</div></Link>
     <div onClick={() => setDropDown({services: !dropDown.services, partners: false})} className={`mobile-tab-dropdown ${isActive(router.pathname, '/services')}`}>
          Services 
     ...
     <div onClick={() => setDropDown({services: false, partners: !dropDown.partners})} className={`mobile-tab-dropdown ${isActive(router.pathname, '/senior-partners')}`}>
           Senior Partners 
    ...
    <Link href="/contact" passHref><div className={`mobile-tab ${isActive(router.pathname, '/contact')}`}>Contact Us</div></Link>
  </div>
}