  ...
  const slides = [
    {
      ...
      caption:
        "Specialist Scalable International Structured Funding and investment products",
    ...
    },
    {
      ...
      caption:
        "SCS are experts in international tax, finance, strategy & funding products and services",
    ...
    },
    {
      ...
      caption:
        "SCS is a team of skilled senior executives with market-leading experience",
      captionPos: "bottom-right-positioning",
      alt: "",
    },
  ];
        ...
        {slides.map((item) => {
          return (
            <SwiperSlide key={item.name}>
              ...
              <div className={`${item.captionPos} caption-text`}>
                {item.caption}
              </div>
            </SwiperSlide>
          );
